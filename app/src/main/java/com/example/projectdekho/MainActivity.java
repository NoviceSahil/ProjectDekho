...
public class MainActivity extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseRVAdapter= new CourseRVAdapter(courseRVModalArrayList,this, (CourseRVAdapter.CourseClickInterface) this);
        courseRVAdapter.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void displayBottomSheet(CourseRVModal courseRVModal){
        ...
        TextView courseDescTV = layout.findViewById(R.id.idTVCourseName);
        ...
        courseDescTV.setText(courseRVModal.getCourseDes());
