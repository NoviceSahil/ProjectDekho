...
//    private BreakIterator CategoryTV;
    ...
    private void displayBottomSheet(ProjectRvModal modal) {
        ...
        courseNameTV.setText(modal.getprojectName());
        courseDescTV.setText(modal.getProjectDescription());
        suitedForTV.setText("Suited for " + modal.getCategory());
        priceTV.setText( modal.getCategory());
